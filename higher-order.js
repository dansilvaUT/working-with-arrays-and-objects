...
//Code Here
let myStrongest = monstersInYourPocket.filter((e, index, wholeArray) => {
  return e.CP > 200;
});
...
let orderTotals = orders.map((e, index, arr) => {
...
let bobsTotal = purchases.reduce((acc, currElement, Currindex, arr) => {
  //console.log(currElement.owner)
  if (currElement.owner === `Bob`) {
